...
Config.RequiredJob = nil -- Job name required to use gunsmith item (set to nil to disable)
Config.Gunsmithprop = `p_gunsmithprops09x`
Config.MaxGunsites = 6
Config.MaxWeapon = 1
Config.PaymentType = 'cash'
Config.animationSave = 10000

-- Zone settings
Config.gunZoneActive = false
Config.gunZoneSize = 3.0
Config.showTextZone = false
...
Config.price = {
    ...
    -- Frame
    ["FRAME_MATERIAL"] = 1.00,
    ["FRAME_ENGRAVING"] = 1.50,
    ["FRAME_ENGRAVING_MATERIAL"] = 0.75,
    
    -- Barrel
    ["BARREL_MATERIAL"] = 1.00,
    ["BARREL_ENGRAVING"] = 1.50,
    ["BARREL_ENGRAVING_MATERIAL"] = 0.75,
    ["BARREL_RIFLING"] = 1.00,
    ["BARREL_TINT"] = 0.50,
    
    -- Cylinder
    ["CYLINDER_MATERIAL"] = 1.00,
    ["CYLINDER_ENGRAVING"] = 1.50,
    ["CYLINDER_ENGRAVING_MATERIAL"] = 0.75,
    ["CYLINDER_TINT"] = 0.50,
    
    -- Trigger/Hammer/Sight
    ["TRIGGER_MATERIAL"] = 0.75,
    ["TRIGGER_TINT"] = 0.50,
    ["HAMMER_MATERIAL"] = 0.75,
    ["SIGHT_MATERIAL"] = 0.75,
    
    -- Melee
    ["MELEE_BLADE_MATERIAL"] = 1.00,
    ["MELEE_BLADE_ENGRAVING"] = 1.50,
    ["MELEE_BLADE_ENGRAVING_MATERIAL"] = 0.75,
    ["STRAP"] = 1.00,
    ["STRAP_TINT"] = 0.50,
    
    -- Misc
    ["TORCH_MATCHSTICK"] = 0.50,
}
...
Config.Shared = {
    ...
    ['SHORTARM'] = {
        ...
        ['WRAP_MATERIAL'] = {
            'COMPONENT_SHORTARM_WRAP_MATERIAL_LEATHER',
            'COMPONENT_SHORTARM_WRAP_MATERIAL_CLOTH',
        },
        ['WRAP_TINT'] = {
            -- Basic Colors
            'COMPONENT_SHORTARM_WRAP_TINT_WHITE',
            'COMPONENT_SHORTARM_WRAP_TINT_BLACK',
            'COMPONENT_SHORTARM_WRAP_TINT_RED',
            'COMPONENT_SHORTARM_WRAP_TINT_BLUE',
            'COMPONENT_SHORTARM_WRAP_TINT_GREEN',
            'COMPONENT_SHORTARM_WRAP_TINT_ORANGE',
            'COMPONENT_SHORTARM_WRAP_TINT_PINK',
            'COMPONENT_SHORTARM_WRAP_TINT_PURPLE',
            'COMPONENT_SHORTARM_WRAP_TINT_GREY',
            'COMPONENT_SHORTARM_WRAP_TINT_BROWN',
            -- A Series
            'COMPONENT_SHORTARM_WRAP_TINT_A_1',
            'COMPONENT_SHORTARM_WRAP_TINT_A_2',
            'COMPONENT_SHORTARM_WRAP_TINT_A_3',
            'COMPONENT_SHORTARM_WRAP_TINT_A_4',
            'COMPONENT_SHORTARM_WRAP_TINT_A_5',
            'COMPONENT_SHORTARM_WRAP_TINT_A_6',
            'COMPONENT_SHORTARM_WRAP_TINT_A_7',
            'COMPONENT_SHORTARM_WRAP_TINT_A_8',
            -- B Series
            'COMPONENT_SHORTARM_WRAP_TINT_B_1',
            'COMPONENT_SHORTARM_WRAP_TINT_B_2',
            'COMPONENT_SHORTARM_WRAP_TINT_B_3',
            'COMPONENT_SHORTARM_WRAP_TINT_B_4',
            'COMPONENT_SHORTARM_WRAP_TINT_B_5',
            'COMPONENT_SHORTARM_WRAP_TINT_B_6',
            'COMPONENT_SHORTARM_WRAP_TINT_B_7',
            'COMPONENT_SHORTARM_WRAP_TINT_B_8',
            -- C Series
            'COMPONENT_SHORTARM_WRAP_TINT_C_1',
            'COMPONENT_SHORTARM_WRAP_TINT_C_2',
            'COMPONENT_SHORTARM_WRAP_TINT_C_3',
            'COMPONENT_SHORTARM_WRAP_TINT_C_4',
            'COMPONENT_SHORTARM_WRAP_TINT_C_5',
            'COMPONENT_SHORTARM_WRAP_TINT_C_6',
            'COMPONENT_SHORTARM_WRAP_TINT_C_7',
            'COMPONENT_SHORTARM_WRAP_TINT_C_8',
            -- D Series
            'COMPONENT_SHORTARM_WRAP_TINT_D_1',
            'COMPONENT_SHORTARM_WRAP_TINT_D_2',
            'COMPONENT_SHORTARM_WRAP_TINT_D_3',
            'COMPONENT_SHORTARM_WRAP_TINT_D_4',
            'COMPONENT_SHORTARM_WRAP_TINT_D_5',
            'COMPONENT_SHORTARM_WRAP_TINT_D_6',
            'COMPONENT_SHORTARM_WRAP_TINT_D_7',
            'COMPONENT_SHORTARM_WRAP_TINT_D_8',
            -- E Series
            'COMPONENT_SHORTARM_WRAP_TINT_E_1',
            'COMPONENT_SHORTARM_WRAP_TINT_E_2',
            'COMPONENT_SHORTARM_WRAP_TINT_E_3',
            'COMPONENT_SHORTARM_WRAP_TINT_E_4',
            'COMPONENT_SHORTARM_WRAP_TINT_E_5',
            'COMPONENT_SHORTARM_WRAP_TINT_E_6',
            'COMPONENT_SHORTARM_WRAP_TINT_E_7',
            'COMPONENT_SHORTARM_WRAP_TINT_E_8',
        },
        ['BARREL_RIFLING'] = {
    ...
    ['LONGARM'] = {
        ...
        ['STRAP_TINT'] = {
            ...
            'COMPONENT_LONGARM_STRAP_TINT_RED',
            'COMPONENT_LONGARM_STRAP_TINT_BLUE',
            'COMPONENT_LONGARM_STRAP_TINT_GREEN',
            'COMPONENT_LONGARM_STRAP_TINT_ORANGE',
            'COMPONENT_LONGARM_STRAP_TINT_PINK',
            'COMPONENT_LONGARM_STRAP_TINT_PURPLE',
            'COMPONENT_LONGARM_STRAP_TINT_WHITE',
            'COMPONENT_LONGARM_STRAP_TINT_BLACK',
            'COMPONENT_LONGARM_STRAP_TINT_BROWN',
            'COMPONENT_LONGARM_STRAP_TINT_GREY',
        },
    },
    ...
    ['SHOTGUN'] = {
        ...
        ['GRIPSTOCK_TINT'] = {
            ...
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_B_7',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_B_8',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_WHITE',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_BLACK',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_RED',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_BLUE',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_GREEN',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_ORANGE',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_PINK',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_PURPLE',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_GREY',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_BROWN',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_GUTTAPERCHA',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_PEARL',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_GRAY_BIRCH',
            'COMPONENT_LONGARM_GRIPSTOCK_TINT_BURLED',
            -- SHORTARM cross-compatible
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_A_1',
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_A_2',
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_A_3',
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_A_4',
            ...
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_B_7',
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_B_8',
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_RED',
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_BLUE',
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_GUTTAPERCHA',
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_PEARL',
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_GRAY_BIRCH',
            'COMPONENT_SHORTARM_GRIPSTOCK_TINT_BURLED',
    ...
    ['MELEE_BLADE'] = {
        ...
        ['GRIP_TINT'] = {
            ...
            'COMPONENT_MELEE_GRIP_TINT_C_1',
            'COMPONENT_MELEE_GRIP_TINT_C_2',
            'COMPONENT_MELEE_GRIP_TINT_C_3',
            'COMPONENT_MELEE_GRIP_TINT_C_4',
            'COMPONENT_MELEE_GRIP_TINT_C_5',
            'COMPONENT_MELEE_GRIP_TINT_C_6',
            'COMPONENT_MELEE_GRIP_TINT_C_7',
            'COMPONENT_MELEE_GRIP_TINT_C_8',
            'COMPONENT_MELEE_GRIP_TINT_D_1',
            'COMPONENT_MELEE_GRIP_TINT_D_2',
            'COMPONENT_MELEE_GRIP_TINT_D_3',
            'COMPONENT_MELEE_GRIP_TINT_D_4',
            'COMPONENT_MELEE_GRIP_TINT_D_5',
            'COMPONENT_MELEE_GRIP_TINT_D_6',
            'COMPONENT_MELEE_GRIP_TINT_D_7',
            'COMPONENT_MELEE_GRIP_TINT_D_8',
            'COMPONENT_MELEE_GRIP_TINT_E_1',
            'COMPONENT_MELEE_GRIP_TINT_E_2',
            'COMPONENT_MELEE_GRIP_TINT_E_3',
            'COMPONENT_MELEE_GRIP_TINT_E_4',
            'COMPONENT_MELEE_GRIP_TINT_E_5',
            'COMPONENT_MELEE_GRIP_TINT_E_6',
            'COMPONENT_MELEE_GRIP_TINT_E_7',
            'COMPONENT_MELEE_GRIP_TINT_E_8',
            -- Special
            'COMPONENT_MELEE_GRIP_TINT_GRAY_BIRCH',
            'COMPONENT_MELEE_GRIP_TINT_RED',
            'COMPONENT_MELEE_GRIP_TINT_PEARL',
            'COMPONENT_MELEE_GRIP_TINT_BURLED',
            'COMPONENT_MELEE_GRIP_TINT_GUTTAPERCHA',
        },
    },
}
...
Config.WeaponDamageModifiers = {
    ...
    -- Revolvers
    [0x0797FBF5] = 3.8,     -- Double Action Revolver
    ...
    [0x83DD5617] = 3.8,     -- Double Action Gambler Revolver
    -- Rifles
    [0x63F46DE6] = 5.0,     -- Springfield Rifle
    [0x772C8DD6] = 5.0,     -- Bolt Action Rifle
    [0xDDF7BC1E] = 5.0,     -- Varmint Rifle
    -- Shotguns
    [0x1765A8F8] = 1.5,     -- Sawed Off Shotgun
